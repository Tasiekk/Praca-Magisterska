...
PowiatyNiemSredni = pd.read_excel('GDA - POWIATY\POWIATY - Niemiecki - Średni wynik.xlsx',index_col=0,header=0)

Srednie=[PowiatyAngSredni,PowiatyJPSredni,PowiatyWOSSredni,PowiatyMATSredni,PowiatyPRZSredni,PowiatyNiemSredni]
...
PowiatyNiemSredni['2018-liniowo']=np.zeros(20)
...
PowiatyNiemSredni['2018-kwadratowo']=np.zeros(20)
...
PowiatyNiemSredni['Błąd-liniowo']=np.zeros(20)
...
PowiatyNiemSredni['Błąd-kwadratowo']=np.zeros(20)
e=np.zeros(4)
